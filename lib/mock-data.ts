import type { Transaction, VirtualCard, Invoice, PaymentLink, SpendingCategory, MonthlyData, User } from './types';
...
export const MOCK_TRANSACTIONS: Transaction[] = [
  ...
  },
  {
    ...
    amount: 1200.00,
    currency: 'USD',
    description: 'Invoice #INV-2024-042 paid',
    counterparty: 'Tech Corp LLC',
    status: 'completed',
    category: 'Invoice',
    date: '2026-04-22T09:00:00Z',
    reference: 'REF-G7H8I9',
  },
  {
    id: 'txn_004',
    type: 'payment',
  ...
  },
  {
    ...
    counterparty: 'StartupX',
    status: 'completed',
    category: 'Freelance',
    date: '2026-04-20T11:20:00Z',
    reference: 'REF-M4N5O6',
  },
  {
    id: 'txn_006',
    type: 'send',
  ...
  },
  {
    ...
    counterparty: 'City Power Co',
    status: 'pending',
    category: 'Utilities',
    date: '2026-04-16T10:00:00Z',
    reference: 'REF-Y7Z8A9',
  },
  {
    id: 'txn_010',
    type: 'refund',
...
export const MOCK_VIRTUAL_CARDS: VirtualCard[] = [
  ...
  },
  {
    ...
    expiryMonth: '06',
    expiryYear: '27',
    cardholderName: 'THE COFFEE HOUSE',
    status: 'frozen',
    spendingLimit: 10000,
    spent: 0,
    network: 'mastercard',
    addedToApplePay: false,
    addedToGooglePay: true,
  },
];
...
export const MOCK_INVOICES: Invoice[] = [
  {
    ...
    items: [
      { description: 'Web design services', quantity: 1, unitPrice: 800, total: 800 },
      { description: 'Logo design', quantity: 1, unitPrice: 400, total: 400 },
    ],
    subtotal: 1200,
    tax: 96,
    total: 1296,
  ...
  },
  {
    id: 'inv_002',
    number: 'INV-2026-042',
    clientName: 'StartupX Inc',
    clientEmail: 'finance@startupx.io',
    items: [
      { description: 'UI/UX consulting (10 hours)', quantity: 10, unitPrice: 150, total: 1500 },
    ],
    subtotal: 1500,
    tax: 120,
    total: 1620,
  ...
  },
  {
    ...
    items: [
      { description: 'Monthly retainer', quantity: 1, unitPrice: 2000, total: 2000 },
    ],
    subtotal: 2000,
    tax: 160,
    total: 2160,
  ...
  },
  {
    ...
    clientEmail: 'owner@localbakery.com',
    items: [
      { description: 'Social media management', quantity: 1, unitPrice: 500, total: 500 },
    ],
    subtotal: 500,
    tax: 40,
    total: 540,
...
export const MOCK_PAYMENT_LINKS: PaymentLink[] = [
  {
    id: 'pl_001',
    title: 'Coffee House Order',
    description: 'Pay for your coffee order',
    amount: undefined,
    currency: 'USD',
    slug: 'coffee-house-order',
    active: true,
    visits: 248,
    payments: 63,
    collected: 1847.50,
